...
Itch.io page: Add published game page link here after uploading.

Repository: Add repository link here if submitting through Git.
...
Breakfast pickup sound is exposed on `Player_S` as:

```text
breakfast_pickup_sound
```
